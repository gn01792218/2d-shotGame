...
(function (EnemyType) {
    ...
    EnemyType[EnemyType["SPAWN"] = 2] = "SPAWN";
})(EnemyType || (EnemyType = {}));
//load事件時，渲染出遊戲場景
window.addEventListener('load', function () {
    ...
    class Particle extends GameObj {
        constructor(game, location) {
            ...
            this.gravity = 0.5;
            this.bounceCount = 0;
            this.bounceBoundaries = 100;
            this.angle = 0;
            this.va = Math.random() * 0.2 - 0.1;
            //讓粒子可以調整大小
            this.spriteSize = 50; //雪碧圖的原圖大小
        ...
        update() {
            ...
            if (this.location.y > this.game.gameSize.height + this.size.height || this.location.x < 0 - this.size.width)
                this.deleted = true;
        ...
        draw(context) {
            ...
            context.drawImage(this.img, this.imgXFrame * this.spriteSize, this.imgYFrame * this.spriteSize, this.spriteSize, this.spriteSize, this.size.width * -0.5, this.size.height * -0.5, this.size.width, this.size.height);
            context.restore();
        }
    }
